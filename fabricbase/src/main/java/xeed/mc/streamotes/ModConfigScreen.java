		...
		return parent -> {
			...
			return YetAnotherConfigLib.createBuilder()
				...
				.category(ConfigCategory.createBuilder()
					.name(Text.translatable("text.config.streamotes.category.main"))
					.tooltip(Text.translatable("text.config.streamotes.option.notice"))
					...
					.option(Option.<Boolean>createBuilder()
						...
						.build())
					.option(Option.<Boolean>createBuilder()
						.name(Text.translatable("text.config.streamotes.option.colorEmotes"))
						.binding(def.colorEmotes, () -> config.colorEmotes, val -> config.colorEmotes = val)
						.controller(BooleanControllerBuilder::create)
						.build())
					.option(Option.<ActivationOption>createBuilder()
						.name(Text.translatable("text.config.streamotes.option.activationMode"))
