...
public class CompatServer {
	...
	public static void onInitializeServer() {
		PayloadTypeRegistry.clientboundPlay().register(JsonPayload.PACKET_ID, JsonPayload.PACKET_CODEC);
	}

	public static Packet<?> createConfigPacket(String json) {
		return ServerPlayNetworking.createClientboundPacket(new JsonPayload(json));
	}
