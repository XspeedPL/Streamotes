...
public class EmoticonGlyph implements BakedGlyph {
	...
	@Override
	public @NotNull GlyphInfo info() {
		return metrics;
	}

	@Override
	public @Nullable TextRenderable createGlyph(float x, float y, int color, int shadowColor, @NotNull Style style, float boldOffset, float shadowOffset) {
		return drawable;
	}

	private class EmoticonDrawable implements TextRenderable {
		@Override
		public void render(@NotNull Matrix4f matrix, @NotNull VertexConsumer consumer, int light, boolean noDepth) {
		...
		@NotNull
		@Override
		public RenderType renderType(Font.@NotNull DisplayMode type) {
