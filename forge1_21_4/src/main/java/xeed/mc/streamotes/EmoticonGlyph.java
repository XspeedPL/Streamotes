...
public class EmoticonGlyph extends BakedGlyph {
	...
	public static EmoticonGlyph of(Emoticon icon, float x, float y, int color) {
		...
		var layerSet = new GlyphRenderTypes(layer, layer, layer, layer, layer, layer);
	...
	@Override
	public void renderChar(BakedGlyph.GlyphInstance glyph, Matrix4f matrix, VertexConsumer consumer, int light) {
